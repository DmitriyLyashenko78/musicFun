...
import type { PlaylistData, UpdatePlaylistFormFields } from '@/features/playlists/api/playlistsApi.types.ts'
...
export const PlaylistsList = ({ isPlaylistsLoading, playlists }: Props) => {
  ...
  const { register, handleSubmit, reset } = useForm<UpdatePlaylistFormFields>()
